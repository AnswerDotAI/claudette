...
async def structured(
    ...
    tool_choice:Optional=None, # Optionally force use of some tool
    cb:NoneType=None, # Callback to pass result to when complete
    cache_control:Optional[CacheControlEphemeralParam] | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    container:Optional[str] | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    inference_geo:Optional[str] | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    metadata:MetadataParam | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    output_config:OutputConfigParam | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    service_tier:Literal['auto', 'standard_only'] | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    stop_sequences:SequenceNotStr[str] | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    system:Union[str, Iterable[TextBlockParam]] | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    temperature:float | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    thinking:ThinkingConfigParam | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    top_k:int | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
    top_p:float | Omit=<anthropic.Omit object at 0x7f0aefc30170>,
