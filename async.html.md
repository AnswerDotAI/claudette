...
async def structured(
    ...
    tool_choice:Optional=None, # Optionally force use of some tool
    cb:NoneType=None, # Callback to pass result to when complete
    cache_control:Optional[CacheControlEphemeralParam] | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    container:Optional[str] | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    inference_geo:Optional[str] | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    metadata:MetadataParam | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    output_config:OutputConfigParam | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    service_tier:Literal['auto', 'standard_only'] | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    stop_sequences:SequenceNotStr[str] | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    system:Union[str, Iterable[TextBlockParam]] | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    temperature:float | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    thinking:ThinkingConfigParam | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    top_k:int | Omit=<anthropic.Omit object at 0x7fda6b599970>,
    top_p:float | Omit=<anthropic.Omit object at 0x7fda6b599970>,
