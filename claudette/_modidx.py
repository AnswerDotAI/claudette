...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'claudette.core': { 'claudette.core.(ToolsBetaMessage, Message)._repr_markdown_': ( 'core.html#(toolsbetamessage, '
            ...
            'claudette.helpers': { 'claudette.helpers._add_nls': ('helpers.html#_add_nls', 'claudette/helpers.py'),
                                   'claudette.helpers.docs_xml': ('helpers.html#docs_xml', 'claudette/helpers.py'),
                                   'claudette.helpers.files2ctx': ('helpers.html#files2ctx', 'claudette/helpers.py'),
                                   'claudette.helpers.folder2ctx': ('helpers.html#folder2ctx', 'claudette/helpers.py'),
                                   'claudette.helpers.hl_md': ('helpers.html#hl_md', 'claudette/helpers.py'),
                                   'claudette.helpers.json_to_xml': ('helpers.html#json_to_xml', 'claudette/helpers.py'),
                                   'claudette.helpers.mk_doc': ('helpers.html#mk_doc', 'claudette/helpers.py'),
