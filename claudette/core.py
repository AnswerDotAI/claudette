"""Docs: https://claudette.answer.ai/core.html.md"""
...
# %% ../nbs/00_core.ipynb #c1cefa1e
_all_ = ['mk_msg', 'mk_msgs']

# %% ../nbs/00_core.ipynb #f5fa6b92
empty = inspect.Parameter.empty

# %% ../nbs/00_core.ipynb #0fff8869
model_types = {
    # Anthropic
...
# %% ../nbs/00_core.ipynb #4f03dcad
models = all_models[:10]

# %% ../nbs/00_core.ipynb #53a6d47a
models_aws = [
...
# %% ../nbs/00_core.ipynb #669696aa
text_only_models = ('claude-3-5-haiku-20241022',)

# %% ../nbs/00_core.ipynb #2411f28d
...
# %% ../nbs/00_core.ipynb #aae25dd2
@patch(as_prop=True)
def cost(self: Chat) -> float: return self.c.cost

# %% ../nbs/00_core.ipynb #d0178ee1
@patch
