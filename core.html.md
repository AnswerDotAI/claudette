...
- id: `msg_01NC6ng9vyFS2vAU5N68Mddw`
- content:
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L123"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L144"
target="_blank" style="float:right; font-size:smaller">source</a>
...
- id: `msg_01RvqMaUztYEQxMXuX9hqpmx`
- content:
  `[{'citations': None, 'text': 'Nice to meet you, Jeremy! How are you doing today? Is there anything I can help you with?', 'type': 'text'}]`
- model: `claude-sonnet-4-20250514`
- role: `assistant`
...
- id: `msg_01TrgN2WXEA4EYBu8aGmhv8U`
- content:
...
- type: `message`
- usage:
  `{'cache_creation_input_tokens': 0, 'cache_read_input_tokens': 0, 'input_tokens': 49, 'output_tokens': 22, 'server_tool_use': None, 'service_tier': 'standard'}`
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L249"
target="_blank" style="float:right; font-size:smaller">source</a>
...
- id: `msg_012kC5SX1tWGnNbhCzJTCjpU`
- content:
...
```
    ...
    [{'max_tokens': 4096,
      ...
      'result': Message(id='msg_012kC5SX1tWGnNbhCzJTCjpU', content=[TextBlock(citations=None, text='Hello! How are you doing today? Is there anything I can help you with?', type='text')], model='claude-sonnet-4-20250514', role='assistant', stop_reason='end_turn', stop_sequence=None, type='message', usage=In: 8; Out: 20; Cache create: 0; Cache read: 0; Total Tokens: 28; Search: 0),
      'stop_reason': 'end_turn',
      'stop_sequence': None,
      'system': '',
      'temperature': 0,
...
answer - it’s likely something each person must discover for themselves
through relationships, purpose, growth, and what brings them meaning.

<details>

- id: `msg_01SVJ2Q1X3rGcvXuJh497ZFi`
- content:
  `[{'citations': None, 'text': "According to Douglas Adams, 42. But seriously, there's no universal answer - it's likely something each person must discover for themselves through relationships, purpose, growth, and what brings them meaning.", 'type': 'text'}]`
- model: `claude-sonnet-4-20250514`
- role: `assistant`
- stop_reason: `end_turn`
- stop_sequence: `None`
- type: `message`
- usage:
  `{'cache_creation_input_tokens': 0, 'cache_read_input_tokens': 0, 'input_tokens': 24, 'output_tokens': 37, 'server_tool_use': None, 'service_tier': 'standard'}`
...
```
    ...
    In: 32; Out: 57; Cache create: 0; Cache read: 0; Total Tokens: 89; Search: 0
...
```
    ...
    In: 40; Out: 77; Cache create: 0; Cache read: 0; Total Tokens: 117; Search: 0
...
- id: `msg_01J7W8XntQuaaPVWmph94Qjv`
- content:
  `[{'citations': None, 'text': 'Hello! How are you doing today? Is there anything I can help you with?', 'type': 'text'}]`
- model: `claude-sonnet-4-20250514`
- role: `assistant`
...
```
    ...
    According to Douglas Adams, 42. But seriously, there's no universal answer - it's likely something each person must discover for themselves through relationships, purpose, growth, and what brings them meaning.

``` python
c.use
```

    In: 64; Out: 114; Cache create: 0; Cache read: 0; Total Tokens: 178; Search: 0
...
- id: `msg_01BbwZhzEQ83yRjFih3Us4eH`
- content:
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L284"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L294"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L306"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<td style="text-align: right;">0.002040</td>
</tr>
<tr>
<td>Cache tokens</td>
...
<td style="text-align: right;"><strong>$0.002322</strong></td>
</tr>
</tbody>
</table>
...
- id: `msg_01Y7xfY968UdP9vWyvNN2V6s`
- content:
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L337"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L347"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L355"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L453"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L498"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L509"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L519"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L526"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/claudette/blob/main/claudette/core.py#L546"
target="_blank" style="float:right; font-size:smaller">source</a>
